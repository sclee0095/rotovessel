...
TESTDLL_NKJ void GetLineLength(std::vector<cv::Point> L, double *o_ll);
TESTDLL_NKJ void getBoundaryDistance(cv::Mat I, cv::Mat *o_BoundaryDistance);
TESTDLL_NKJ void maxDistancePoint(cv::Mat BoundaryDistance, cv::Mat I, cv::Point *o_posD, double *o_maxD);
//TESTDLL_NKJ void maxDistancePoint(cv::Mat BoundaryDistance, cv::Mat I, double *o_maxD);
