...
struct VCO_EXPORTS ves_feat_pt
{
	int x;
	int y;
...
private:
	...
	void get_linked(std::vector<std::vector<cv::Point>> pts, std::vector<cv::Point> *o_end, std::vector<cv::Point> *o_juntion);
