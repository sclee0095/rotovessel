...
void perform_front_propagation_2d_addpd(
	...
	int i_nb_end_points,
	double **o_D, T_callback_intert_node callback_insert_node)
{
	n = i_n;
	p = i_p;
	D = i_D;
	...
	L = i_L;
	PD = i_PD;
	start_points = i_start_points;
	end_points = i_end_points;
	H = i_H;
	values = i_values;
	nb_iter_max = i_nb_iter_max;
	nb_start_points = i_nb_start_points;
	nb_end_points = i_nb_end_points;
